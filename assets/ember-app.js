  ...
  exports.default = {
    projections: {
      БаржиE: {
        ...
        грузопод: {
          __caption__: 'Грузоподъемность, т'
        },
        длина: {
          __caption__: 'Длина, м'
        },
      ...
      ДокумРезультПE: {
        ...
        тЧДостКонт: {
          ...
          груз: {
            ...
            объем: {
              __caption__: 'Объем поставленного груза, м^3'
            }
          }
        },
        тЧСвобМест: {
          ...
          свобОбъем: {
            __caption__: 'Освободившийся объем, м^3'
          }
        }
      },
      ДокумРезультПL: {
    ...
    projections: {
      ЗагрузКонтейнE: {
        ...
        контейнеры: {
          ...
          максВес: {
            __caption__: 'Максимальный вес контейнера, т'
          }
        },
        объемСвобод: {
        ...
        остатокПоВесу: {
          __caption__: 'Остаток по весу контейнера, т'
        },
        тЧИнфОГрузе: {
    ...
    projections: {
      ЗагрузкаБаржиE: {
        ...
        баржи: {
          ...
          грузопод: {
            __caption__: 'Грузоподъемность баржи, т'
          }
        },
        объемБарСв: {
        ...
        остатокПоВесу: {
          __caption__: 'Остаток по весу баржи, т'
        },
        тЧИнфОКонт: {
      ...
      ЗагрузкаБаржиL: {
        ...
        баржи: {
          ...
          грузопод: {
            __caption__: 'Грузоподбъемность баржи, т'
          }
        },
        объемБарСв: {
          __caption__: 'Свободный объем баржи, м^3'
...
define('ember-app/mixins/regenerated/models/i-i-s-logistika-\u0431\u0430\u0440\u0436\u0438', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('БаржиE', 'i-i-s-logistika-баржи', {
      ...
      грузопод: (0, _attributes.attr)('Грузоподъемность, т', { index: 1 }),
    ...
    modelClass.defineProjection('ДокумПоставE', 'i-i-s-logistika-докум-постав', {
      ...
      тЧИнфОЗак: (0, _attributes.hasMany)('i-i-s-logistika-т-ч-инф-о-зак', 'Информация о заказе', {
        груз: (0, _attributes.belongsTo)('i-i-s-logistika-груз', 'Код груза', {
          ...
          масса: (0, _attributes.attr)('Масса груза, кг', { index: 3 }),
          объем: (0, _attributes.attr)('Объем груза, м^3', { index: 4 })
        }, { index: 0, displayMemberPath: 'кодГруза' }),
        количество: (0, _attributes.attr)('Количество груза, шт', { index: 5 })
      })
    });
    ...
    modelClass.defineProjection('ДокумРезультПE', 'i-i-s-logistika-докум-результ-п', {
      ...
      тЧДостКонт: (0, _attributes.hasMany)('i-i-s-logistika-т-ч-дост-кон', 'Доставленные контейнеры', {
        ...
        груз: (0, _attributes.belongsTo)('i-i-s-logistika-груз', 'Код груза', {
          ...
          объем: (0, _attributes.attr)('Объем поставленного груза, м^3', { index: 5 })
      ...
      тЧСвобМест: (0, _attributes.hasMany)('i-i-s-logistika-т-ч-своб-мест', 'Свободное место в контейнерах', {
        загрузКонтейн: (0, _attributes.belongsTo)('i-i-s-logistika-загруз-контейн', 'Номер документа загрузки контейнеров', {
          ...
          контейнеры: (0, _attributes.belongsTo)('i-i-s-logistika-контейнеры', '', {
            ...
            объем: (0, _attributes.attr)('Объем контейнера, м^3', { index: 3 })
          }, { index: -1, hidden: true })
        }, { index: 0, displayMemberPath: 'номерДокЗагк' }),
        свобОбъем: (0, _attributes.attr)('Освободившийся объем, м^3', { index: 4 })
      })
    });
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('ЗагрузКонтейнE', 'i-i-s-logistika-загруз-контейн', {
      ...
      контейнеры: (0, _attributes.belongsTo)('i-i-s-logistika-контейнеры', 'Номер контейнера', {
        ...
        максВес: (0, _attributes.attr)('Максимальный вес контейнера, т', { index: 8 })
      }, { index: 4, displayMemberPath: 'номерКонтей' }),
      объемСвобод: (0, _attributes.attr)('Свободный объем контейнера, м^3', { index: 7 }),
      остатокПоВесу: (0, _attributes.attr)('Остаток по весу контейнера, т', { index: 9 }),
      тЧИнфОГрузе: (0, _attributes.hasMany)('i-i-s-logistika-т-ч-инф-о-грузе', 'Информация о грузе', {
        груз: (0, _attributes.belongsTo)('i-i-s-logistika-груз', 'Код груза', {
          кодГруза: (0, _attributes.attr)('Код груза', { index: 1, hidden: true }),
          категорияГр: (0, _attributes.attr)('Категория груза', { index: 2 }),
          объем: (0, _attributes.attr)('Объем груза, м^3', { index: 3 }),
          масса: (0, _attributes.attr)('Масса груза, кг', { index: 4 })
        }, { index: 0, displayMemberPath: 'кодГруза' })
      })
    });
    ...
    modelClass.defineProjection('ЗагрузКонтейнL', 'i-i-s-logistika-загруз-контейн', {
      ...
      контейнеры: (0, _attributes.belongsTo)('i-i-s-logistika-контейнеры', 'Номер контейнера', {
        ...
        максВес: (0, _attributes.attr)('Максимальный вес, т', { index: 6 })
      }, { index: -1, hidden: true }),
      объемСвобод: (0, _attributes.attr)('Свободный объем контейнера, м^3', { index: 5 }),
      остатокПоВесу: (0, _attributes.attr)('Остаток по весу контейнера, т', { index: 7 })
    });
  };
});
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('ЗагрузкаБаржиE', 'i-i-s-logistika-загрузка-баржи', {
      ...
      баржи: (0, _attributes.belongsTo)('i-i-s-logistika-баржи', 'Номер баржи', {
        ...
        объемБаржи: (0, _attributes.attr)('Объем баржи, м^3', { index: 6 }),
        грузопод: (0, _attributes.attr)('Грузоподъемность баржи, т', { index: 8 })
      }, { index: 4, displayMemberPath: 'номерБаржи' }),
      объемБарСв: (0, _attributes.attr)('Свободный объем баржи, м^3', { index: 7 }),
      остатокПоВесу: (0, _attributes.attr)('Остаток по весу баржи, т', { index: 9 }),
      тЧИнфОКонт: (0, _attributes.hasMany)('i-i-s-logistika-т-ч-инф-о-конт', 'Информация о погруженных контейнерах', {
        загрузКонтейн: (0, _attributes.belongsTo)('i-i-s-logistika-загруз-контейн', 'Номер документа загрузки контейнеров', {
          ...
          контейнеры: (0, _attributes.belongsTo)('i-i-s-logistika-контейнеры', '', {
            номерКонтей: (0, _attributes.attr)('Номер контейнера', { index: 2 }),
            объем: (0, _attributes.attr)('Объем контейнера, м^3', { index: 3 }),
            максВес: (0, _attributes.attr)('Максимальный вес контейнера, т', { index: 4 })
          }, { index: -1, hidden: true })
        }, { index: 0, displayMemberPath: 'номерДокЗагк' }),
        докумПостав: (0, _attributes.belongsTo)('i-i-s-logistika-докум-постав', 'Номер документа поставки', {
    ...
    modelClass.defineProjection('ЗагрузкаБаржиL', 'i-i-s-logistika-загрузка-баржи', {
      ...
      баржи: (0, _attributes.belongsTo)('i-i-s-logistika-баржи', 'Номер баржи', {
        ...
        грузопод: (0, _attributes.attr)('Грузоподбъемность баржи, т', { index: 6 })
      }, { index: -1, hidden: true }),
      объемБарСв: (0, _attributes.attr)('Свободный объем баржи, м^3', { index: 5 }),
      остатокПоВесу: (0, _attributes.attr)('Остаток по весу баржи, т', { index: 7 })
    });
  };
});
		...
		exports.default = _offlineGlobals.default.extend({
				...
				getOfflineSchema: function getOfflineSchema() {
						...
						var returnedSchema = Ember.merge(parentSchema, {
								...
								'i-i-s-logistika-докум-результ-п': 'id,дата,датаПриб,докумПостав,*тЧДостКонт,*тЧСвобМест',
