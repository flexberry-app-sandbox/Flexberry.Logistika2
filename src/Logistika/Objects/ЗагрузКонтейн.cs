...
namespace IIS.Logistika
{
    ...
    [View("ЗагрузКонтейнE", new string[] {
            ...
            "Контейнеры.МаксВес as \'Максимальный вес контейнера, т\'",
            "ОстатокПоВесу as \'Остаток по весу контейнера, т\'"}, Hidden=new string[] {
    ...
    [View("ЗагрузКонтейнL", new string[] {
            ...
            "Контейнеры.Объем as \'Объем контейнера, м^3\'",
            "ОбъемСвобод as \'Свободный объем контейнера, м^3\'",
            "Контейнеры.МаксВес as \'Максимальный вес, т\'",
            "ОстатокПоВесу as \'Остаток по весу контейнера, т\'"})]
