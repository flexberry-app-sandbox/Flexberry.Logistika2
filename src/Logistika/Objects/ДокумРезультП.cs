...
namespace IIS.Logistika
{
    ...
    public class ДокумРезультП : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika.DetailArrayOfТЧДостКон fТЧДостКонт;
        
        private IIS.Logistika.DetailArrayOfТЧСвобМест fТЧСвобМест;
        ...
        public virtual IIS.Logistika.DetailArrayOfТЧДостКон ТЧДостКонт
        {
            get
            {
                ...
                {
                    this.fТЧДостКонт = new IIS.Logistika.DetailArrayOfТЧДостКон(this);
                }
                IIS.Logistika.DetailArrayOfТЧДостКон result = this.fТЧДостКонт;
        ...
        public virtual IIS.Logistika.DetailArrayOfТЧСвобМест ТЧСвобМест
        {
            get
            {
                ...
                {
                    this.fТЧСвобМест = new IIS.Logistika.DetailArrayOfТЧСвобМест(this);
                }
                IIS.Logistika.DetailArrayOfТЧСвобМест result = this.fТЧСвобМест;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумРезультПE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумРезультПE", typeof(IIS.Logistika.ДокумРезультП));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумРезультПL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумРезультПL", typeof(IIS.Logistika.ДокумРезультП));
                }
            }
        }
    }
